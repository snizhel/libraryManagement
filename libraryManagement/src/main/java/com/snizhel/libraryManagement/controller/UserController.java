...
public class UserController {
    ...
    public ResponseEntity<BorrowBook> setStatus(@PathVariable("id") Integer id) {
        borrowBookService.setStatus(id);
        return new ResponseEntity<>(HttpStatus.OK);
    }

    @GetMapping("/borrow/{id}")
    public ResponseEntity<List<BorrowBook>> getAllBorrowBookByUserId(@PathVariable("id") Integer id) {
        List<BorrowBook> borrowBooks = borrowBookService.getAllBorrowBookByUserId(id);
        return new ResponseEntity<>(borrowBooks, HttpStatus.OK);
    }
}
